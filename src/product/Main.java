...
public class Main {
    ...
    private static TradableDTO addOrder(String user, String price, int volume, BookSide side) {
        try {
            return productBook.add(new Order(user, "TGT", PriceFactory.makePrice(price), side, volume));
        } catch (Exception e) {
    ...
    private static void printTopOfBook() {
        ...
        System.out.println();
        System.out.println("Top of BUY book: " + productBook.getTopOfBookSide(BUY));
        System.out.println("Top of SELL book: " + productBook.getTopOfBookSide(SELL));
        System.out.println();
